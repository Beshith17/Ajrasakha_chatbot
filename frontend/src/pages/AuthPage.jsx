      ...
      <section className="auth-card slide-up">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <input autoComplete={usingPhoneAuth ? 'tel' : 'email'} onChange={(event) => handleIdentifierChange(event.target.value)} placeholder="farmer.support@example.com or +91 9876543210" type="text" value={identifier}/>
          </label>

          <label>
            Password
            <input autoComplete={isSignup ? 'new-password' : 'current-password'} onChange={(event) => setPassword(event.target.value)} placeholder="Minimum 6 characters" type="password" value={password}/>
          </label>
