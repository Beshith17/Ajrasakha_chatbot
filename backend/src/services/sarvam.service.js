...
export async function sarvamTranslateText(text, targetLanguage) {
...
export async function sarvamTranscribeAudio(file, mimeType, language) {
    if (!hasSarvam()) {
...
export async function sarvamSynthesizeSpeech(text, language) {
    if (!hasSarvam()) {
        throw new Error('Sarvam is not configured.');
    }
